...
# ========================================================================
# Step 5: Install User Display Dependencies
# ========================================================================
echo "[5/5] Installing User Display (Desktop App) dependencies..."
cd user_display

# Install dependencies
npm install --quiet 2>&1 | grep -E "added|removed|updated|audited" || true

echo "[OK] User Display dependencies installed"
cd ..
echo ""
...
chmod +x start.sh start_worker.sh dev.sh setup_pm2.sh setup_autologin.sh 2>/dev/null || true
...
echo "     ./setup_pm2.sh"
echo ""
echo "  4. (Optional) Setup auto-login:"
echo "     ./setup_autologin.sh"
echo ""
echo "  5. Build Desktop App:"
echo "     cd user_display && npm run dist:linux"
echo ""
echo "Database:"
